      ...
      <div class="main-content-header">
        <form method="post" action="result.php">
          ...
          <table class="table2">
              ...
              <th>Total</th>
                  <th>
                   <?php echo $data2['u_amharic']+$data2['u_english1']+$data2['u_math1']+$data2['u_physics1']+$data2['u_chemestry1']; ?>
                  </th>
                  <th>
                  <?php echo $data2['u_amharic2']+$data2['u_english2']+$data2['u_math2']+$data2['u_physics2']+$data2['u_chemestry']; ?>
                  </th>
