          ...
          <form method="post" action="result.php">
            ...
            <table class="table2">
              ...
              <tr>
                ...
                <th>Amharic</th>
                <th><?php echo $data2['u_amharic1']; ?></th>
                <th><?php echo $data2['u_amharic2']; ?></th>
                <th><?php echo $total1 = $data2['u_amharic1'] + $data2['u_amharic2']; ?> </th>
                <th>200</th>
              </tr>
              <tr>
                <th>English</th>
              ...
              <tr>
                ...
                <th><?php echo $data2['u_chemestry2']; ?></th>
                <th><?php echo $total5 = $data2['u_chemestry1'] + $data2['u_chemestry2']; ?></th>
                <th>200</th>
              </tr>
              <tr>
                <th>Total</th>
                <th>
                  <?php echo $data2['u_amharic1'] + $data2['u_english1'] + $data2['u_math1'] + $data2['u_physics1'] + $data2['u_chemestry1']; ?>
                </th>
                <th>
                  <?php echo $data2['u_amharic2'] + $data2['u_english2'] + $data2['u_math2'] + $data2['u_physics2'] + $data2['u_chemestry2']; ?>
                </th>
