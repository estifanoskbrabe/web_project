    ...
    <header>
      ...
      <div class="main-content-header">
          ...
          <table class="table1">
             ...
             <tr>
                 <td>
                <input type='text' name='amharic1' value="<?php echo $data['u_amharic1']; ?>" class="th" required/></td>
         ...
         <table class="table4">
             ...
             <tr>
                 <td><input type='text' name='amharic2' value="<?php echo $data['u_amharic2']; ?> " class="th" required/></td>
