...
<head>
  ...
  <script defer src="../web_project/javascript/contactus.js"></script>
</head>
    ...
    <div class="main-content-header">
      <form id="form" method='post' onsubmit="return validateForm()">
        <table class="table">
          ...
          <tr>
            <td class='tbldata'><input id="email" type='text' class='tbldata' name='email' placeholder='Email Id' Required /></td>
          </tr>
          <tr>
            <th class='tblheading'>Enter your Contact No.</th>
          </tr>
          <tr>
            <td class='tbldata'><input id="contact" type='text' class='tbldata' name='cont' placeholder='Contact No' Required /></td>
          </tr>
          <tr>
